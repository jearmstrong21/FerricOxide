...
//import mackycheese21.ferricoxide.ast.module.FunctionPrototype;
//import mackycheese21.ferricoxide.ast.module.TraitImpl;
...
//                }
//                for(TraitImpl traitImpl: object.result.traits) {
//                    for(Function function : traitImpl.implementations()) {
//                        if(function.name.getLast().equals(methodName)) {
//                            Expression newFunction = new AccessVar(callExpr.function.span, false, AccessVar.Type.FUNCTION, function.name);
//                            newFunction.result(function.type);
//                            List<Expression> newParams = new ArrayList<>();
//
//                        }
//                    }
